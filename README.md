...
Command for local run and testing, .env description, link mongodb
...
Docker build command, docker run command, link to dockerhub, link to site, link mongodb docker
